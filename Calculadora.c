...
printf("\n------------------------------------------------------------------------\n\n");
	...
	//Fórmulas matemáticas:
		...
		scanf("%i", &operacao_extra);
				...
				//Valor de Pi:
		if(operacao_extra == 1){
		printf("O valor de Pi é: 3,14159265358979323846…\n");
		}
				//Gravidade do planeta terra:
		if(operacao_extra == 2){
		printf("A gravidade da terra é: 9,807 m/s².\n");
		}
				//Gravidade da lua:
		if(operacao_extra == 3){
		printf("A gravidade da lua é: 1,62 m/s².\n");
		}
//Finalizações:
printf("\n------------------------------------------------------------------------\n\n");
printf("|***Obrigada pela visita! Feche a aplicação.<3***|\n\n");
system("Pause");
return 0;
}
//Fim do código.
